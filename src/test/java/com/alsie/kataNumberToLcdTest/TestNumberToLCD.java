...
@RunWith(Suite.class)
@Suite.SuiteClasses({TestNumberToLCD.TestNumberToLCD_FOR_0_TO_9.class, TestNumberToLCD.TestNumberToLCD_FOR_100_TO_900.class,TestNumberToLCD.TestNumberToLCD_YEARS.class,TestNumberToLCD.TestNumberToLCD_LEVEL.class})
